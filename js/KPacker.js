class KPacker {
    ...
    constructor(kpack_data) {
        this.kpack_data = kpack_data;
    }

    unpack() {
        const kpack_header = {
            magic: this.kpack_data.getUint32(0, true),
            unpack_size: this.kpack_data.getUint32(4, true),
            flags: this.kpack_data.getUint32(8, true),
        };
        ...
        const packed_data = new DataView(this.kpack_data.buffer, KPacker.KPACK_PACKED_DATA_OFFSET);
